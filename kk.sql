...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Čtv 16. bře 2017, 02:11
...
--
-- Struktura tabulky `oc_affiliate`
--
...
--
-- Struktura tabulky `oc_affiliate_activity`
--
...
--
-- Struktura tabulky `oc_affiliate_login`
--
...
--
-- Struktura tabulky `oc_affiliate_transaction`
--
...
--
-- Vypisuji data pro tabulku `oc_api`
--

INSERT INTO `oc_api` (`api_id`, `name`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Default', '', 1, '2017-03-14 21:17:34', '2017-03-14 21:17:34');

-- --------------------------------------------------------

--
-- Struktura tabulky `oc_api_ip`
--
...
--
-- Struktura tabulky `oc_api_session`
--
...
--
-- Struktura tabulky `oc_attribute`
--
...
--
-- Vypisuji data pro tabulku `oc_attribute`
--
...
--
-- Struktura tabulky `oc_attribute_description`
--
...
--
-- Vypisuji data pro tabulku `oc_attribute_description`
--
...
--
-- Struktura tabulky `oc_attribute_group`
--
...
--
-- Vypisuji data pro tabulku `oc_attribute_group`
--
...
--
-- Struktura tabulky `oc_attribute_group_description`
--
...
--
-- Vypisuji data pro tabulku `oc_attribute_group_description`
--
...
--
-- Vypisuji data pro tabulku `oc_banner`
--
...
--
-- Struktura tabulky `oc_banner_image`
--
...
--
-- Vypisuji data pro tabulku `oc_banner_image`
--
...
--
-- Vypisuji data pro tabulku `oc_category`
--
...
--
-- Struktura tabulky `oc_category_description`
--
...
--
-- Vypisuji data pro tabulku `oc_category_description`
--
...
--
-- Struktura tabulky `oc_category_filter`
--
...
--
-- Struktura tabulky `oc_category_path`
--
...
--
-- Vypisuji data pro tabulku `oc_category_path`
--
...
--
-- Struktura tabulky `oc_category_to_layout`
--
...
--
-- Struktura tabulky `oc_category_to_store`
--
...
--
-- Vypisuji data pro tabulku `oc_category_to_store`
--
...
--
-- Vypisuji data pro tabulku `oc_country`
--
...
--
-- Vypisuji data pro tabulku `oc_coupon`
--
...
--
-- Struktura tabulky `oc_coupon_category`
--
...
--
-- Struktura tabulky `oc_coupon_history`
--
...
--
-- Struktura tabulky `oc_coupon_product`
--
...
--
-- Vypisuji data pro tabulku `oc_currency`
--

INSERT INTO `oc_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.82309997, 1, '2017-03-14 21:22:14'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2017-03-15 16:28:34'),
(3, 'Euro', 'EUR', '', '€', '2', 0.94300002, 1, '2017-03-14 21:22:14');

-- --------------------------------------------------------

--
-- Struktura tabulky `oc_customer`
--
...
--
-- Struktura tabulky `oc_customer_activity`
--
...
--
-- Struktura tabulky `oc_customer_group`
--
...
--
-- Vypisuji data pro tabulku `oc_customer_group`
--
...
--
-- Struktura tabulky `oc_customer_group_description`
--
...
--
-- Vypisuji data pro tabulku `oc_customer_group_description`
--
...
--
-- Struktura tabulky `oc_customer_history`
--
...
--
-- Struktura tabulky `oc_customer_ip`
--
...
--
-- Struktura tabulky `oc_customer_login`
--
...
--
-- Struktura tabulky `oc_customer_online`
--
...
--
-- Struktura tabulky `oc_customer_reward`
--
...
--
-- Struktura tabulky `oc_customer_search`
--
...
--
-- Struktura tabulky `oc_customer_transaction`
--
...
--
-- Struktura tabulky `oc_customer_wishlist`
--
...
--
-- Struktura tabulky `oc_custom_field`
--
...
--
-- Struktura tabulky `oc_custom_field_customer_group`
--
...
--
-- Struktura tabulky `oc_custom_field_description`
--
...
--
-- Struktura tabulky `oc_custom_field_value`
--
...
--
-- Struktura tabulky `oc_custom_field_value_description`
--
...
--
-- Struktura tabulky `oc_download_description`
--
...
--
-- Vypisuji data pro tabulku `oc_event`
--
...
--
-- Struktura tabulky `oc_extension`
--
...
--
-- Vypisuji data pro tabulku `oc_extension`
--
...
--
-- Struktura tabulky `oc_filter_description`
--
...
--
-- Struktura tabulky `oc_filter_group`
--
...
--
-- Struktura tabulky `oc_filter_group_description`
--
...
--
-- Vypisuji data pro tabulku `oc_geo_zone`
--
...
--
-- Struktura tabulky `oc_information`
--
...
--
-- Vypisuji data pro tabulku `oc_information`
--
...
--
-- Struktura tabulky `oc_information_description`
--
...
--
-- Vypisuji data pro tabulku `oc_information_description`
--
...
--
-- Struktura tabulky `oc_information_to_layout`
--
...
--
-- Struktura tabulky `oc_information_to_store`
--
...
--
-- Vypisuji data pro tabulku `oc_information_to_store`
--
...
--
-- Vypisuji data pro tabulku `oc_language`
--

INSERT INTO `oc_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `sort_order`, `status`) VALUES
(1, 'English', 'en-gb', 'en-US,en_US.UTF-8,en_US,en-gb,english', 'gb.png', 'english', 1, 1),
(2, 'Čeština', 'cs-cz', 'cs', '', '', 1, 1);

-- --------------------------------------------------------

--
-- Struktura tabulky `oc_layout`
--
...
--
-- Vypisuji data pro tabulku `oc_layout`
--
...
--
-- Struktura tabulky `oc_layout_module`
--
...
--
-- Vypisuji data pro tabulku `oc_layout_module`
--
...
--
-- Struktura tabulky `oc_layout_route`
--
...
--
-- Vypisuji data pro tabulku `oc_layout_route`
--
...
--
-- Struktura tabulky `oc_length_class`
--
...
--
-- Vypisuji data pro tabulku `oc_length_class`
--
...
--
-- Struktura tabulky `oc_length_class_description`
--
...
--
-- Vypisuji data pro tabulku `oc_length_class_description`
--
...
--
-- Struktura tabulky `oc_manufacturer`
--
...
--
-- Vypisuji data pro tabulku `oc_manufacturer`
--
...
--
-- Struktura tabulky `oc_manufacturer_to_store`
--
...
--
-- Vypisuji data pro tabulku `oc_manufacturer_to_store`
--
...
--
-- Struktura tabulky `oc_marketing`
--
...
--
-- Struktura tabulky `oc_menu_description`
--
...
--
-- Struktura tabulky `oc_menu_module`
--
...
--
-- Struktura tabulky `oc_modification`
--
...
--
-- Vypisuji data pro tabulku `oc_module`
--
...
--
-- Vypisuji data pro tabulku `oc_option`
--
...
--
-- Struktura tabulky `oc_option_description`
--
...
--
-- Vypisuji data pro tabulku `oc_option_description`
--
...
--
-- Struktura tabulky `oc_option_value`
--
...
--
-- Vypisuji data pro tabulku `oc_option_value`
--
...
--
-- Struktura tabulky `oc_option_value_description`
--
...
--
-- Vypisuji data pro tabulku `oc_option_value_description`
--
...
--
-- Struktura tabulky `oc_order_custom_field`
--
...
--
-- Struktura tabulky `oc_order_history`
--
...
--
-- Struktura tabulky `oc_order_option`
--
...
--
-- Struktura tabulky `oc_order_product`
--
...
--
-- Struktura tabulky `oc_order_recurring`
--
...
--
-- Struktura tabulky `oc_order_recurring_transaction`
--
...
--
-- Struktura tabulky `oc_order_status`
--
...
--
-- Vypisuji data pro tabulku `oc_order_status`
--
...
--
-- Struktura tabulky `oc_order_total`
--
...
--
-- Struktura tabulky `oc_order_voucher`
--
...
--
-- Vypisuji data pro tabulku `oc_product`
--
...
--
-- Struktura tabulky `oc_product_attribute`
--
...
--
-- Vypisuji data pro tabulku `oc_product_attribute`
--
...
--
-- Struktura tabulky `oc_product_description`
--
...
--
-- Vypisuji data pro tabulku `oc_product_description`
--
...
--
-- Struktura tabulky `oc_product_discount`
--
...
--
-- Vypisuji data pro tabulku `oc_product_discount`
--
...
--
-- Struktura tabulky `oc_product_filter`
--
...
--
-- Struktura tabulky `oc_product_image`
--
...
--
-- Vypisuji data pro tabulku `oc_product_image`
--
...
--
-- Struktura tabulky `oc_product_option`
--
...
--
-- Vypisuji data pro tabulku `oc_product_option`
--
...
--
-- Struktura tabulky `oc_product_option_value`
--
...
--
-- Vypisuji data pro tabulku `oc_product_option_value`
--
...
--
-- Struktura tabulky `oc_product_recurring`
--
...
--
-- Struktura tabulky `oc_product_related`
--
...
--
-- Vypisuji data pro tabulku `oc_product_related`
--
...
--
-- Struktura tabulky `oc_product_reward`
--
...
--
-- Vypisuji data pro tabulku `oc_product_reward`
--
...
--
-- Struktura tabulky `oc_product_special`
--
...
--
-- Vypisuji data pro tabulku `oc_product_special`
--
...
--
-- Struktura tabulky `oc_product_to_category`
--
...
--
-- Vypisuji data pro tabulku `oc_product_to_category`
--
...
--
-- Struktura tabulky `oc_product_to_download`
--
...
--
-- Struktura tabulky `oc_product_to_layout`
--
...
--
-- Struktura tabulky `oc_product_to_store`
--
...
--
-- Vypisuji data pro tabulku `oc_product_to_store`
--
...
--
-- Struktura tabulky `oc_recurring`
--
...
--
-- Struktura tabulky `oc_recurring_description`
--
...
--
-- Struktura tabulky `oc_return_action`
--
...
--
-- Vypisuji data pro tabulku `oc_return_action`
--
...
--
-- Struktura tabulky `oc_return_history`
--
...
--
-- Struktura tabulky `oc_return_reason`
--
...
--
-- Vypisuji data pro tabulku `oc_return_reason`
--
...
--
-- Struktura tabulky `oc_return_status`
--
...
--
-- Vypisuji data pro tabulku `oc_return_status`
--
...
--
-- Vypisuji data pro tabulku `oc_setting`
--
...
(352, 0, 'config', 'config_encryption', '', 0),
...
(284, 0, 'config', 'config_zone_id', '899', 0),
...
(283, 0, 'config', 'config_country_id', '56', 0),
...
(273, 0, 'config', 'config_name', 'Nejlepší kusové koberce', 0),
(274, 0, 'config', 'config_owner', 'Your Name', 0),
(275, 0, 'config', 'config_address', 'Address 1', 0),
(276, 0, 'config', 'config_geocode', '', 0),
(277, 0, 'config', 'config_email', 'trnkak@email.cz', 0),
(278, 0, 'config', 'config_telephone', '123456789', 0),
(269, 0, 'config', 'config_meta_description', 'Nejlepší kusové koberce', 0),
(268, 0, 'config', 'config_meta_title', 'Nejlepší kusové koberce', 0),
(357, 0, 'config', 'config_error_log', '1', 0),
(358, 0, 'config', 'config_error_filename', 'error.log', 0),
(359, 1, 'config', 'config_url', 'localhost/kk/test', 0),
(360, 1, 'config', 'config_ssl', '', 0),
(361, 1, 'config', 'config_meta_title', 'test', 0),
(362, 1, 'config', 'config_meta_description', '', 0),
(363, 1, 'config', 'config_meta_keyword', '', 0),
(364, 1, 'config', 'config_theme', 'theme_default', 0),
(365, 1, 'config', 'config_layout_id', '6', 0),
(366, 1, 'config', 'config_name', 'test', 0),
(367, 1, 'config', 'config_owner', 'test', 0),
(368, 1, 'config', 'config_address', 'tst', 0),
(369, 1, 'config', 'config_geocode', 'Česká republika', 0),
(370, 1, 'config', 'config_email', 'marklar2010@gmail.com', 0),
(371, 1, 'config', 'config_telephone', '734846639', 0),
(372, 1, 'config', 'config_fax', '734846639', 0),
(373, 1, 'config', 'config_image', '', 0),
(374, 1, 'config', 'config_open', '', 0),
(375, 1, 'config', 'config_comment', '', 0),
(376, 1, 'config', 'config_country_id', '56', 0),
(377, 1, 'config', 'config_zone_id', '899', 0),
(378, 1, 'config', 'config_language', 'cs-cz', 0),
(379, 1, 'config', 'config_currency', 'USD', 0),
(380, 1, 'config', 'config_tax', '0', 0),
(381, 1, 'config', 'config_tax_default', '', 0),
(382, 1, 'config', 'config_tax_customer', '', 0),
(383, 1, 'config', 'config_customer_group_id', '1', 0),
(384, 1, 'config', 'config_customer_price', '0', 0),
(385, 1, 'config', 'config_account_id', '0', 0),
(386, 1, 'config', 'config_cart_weight', '0', 0),
(387, 1, 'config', 'config_checkout_guest', '0', 0),
(388, 1, 'config', 'config_checkout_id', '0', 0),
(389, 1, 'config', 'config_order_status_id', '7', 0),
(390, 1, 'config', 'config_stock_display', '0', 0),
(391, 1, 'config', 'config_stock_checkout', '0', 0),
(392, 1, 'config', 'config_logo', '', 0),
(393, 1, 'config', 'config_icon', '', 0),
(394, 1, 'config', 'config_secure', '0', 0);

-- --------------------------------------------------------

--
-- Struktura tabulky `oc_stock_status`
--
...
--
-- Vypisuji data pro tabulku `oc_stock_status`
--
...
--
-- Vypisuji data pro tabulku `oc_store`
--

INSERT INTO `oc_store` (`store_id`, `name`, `url`, `ssl`) VALUES
(1, 'test', 'localhost/kk/test', '');

-- --------------------------------------------------------

--
-- Struktura tabulky `oc_tax_class`
--
...
--
-- Vypisuji data pro tabulku `oc_tax_class`
--
...
--
-- Vypisuji data pro tabulku `oc_tax_rate`
--
...
--
-- Struktura tabulky `oc_tax_rate_to_customer_group`
--
...
--
-- Vypisuji data pro tabulku `oc_tax_rate_to_customer_group`
--
...
--
-- Vypisuji data pro tabulku `oc_tax_rule`
--
...
--
-- Struktura tabulky `oc_translation`
--
...
--
-- Struktura tabulky `oc_url_alias`
--
...
--
-- Vypisuji data pro tabulku `oc_url_alias`
--
...
--
-- Vypisuji data pro tabulku `oc_user`
--

INSERT INTO `oc_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `image`, `code`, `ip`, `status`, `date_added`) VALUES
(1, 1, 'admin', '7daabe686acff9b5d8955405f9125893243382f5', 'HS9Qh7Bpn', 'John', 'Doe', 'trnkak@email.cz', '', '', '::1', 1, '2017-03-14 21:17:34');

-- --------------------------------------------------------

--
-- Struktura tabulky `oc_user_group`
--
...
--
-- Vypisuji data pro tabulku `oc_user_group`
--
...
--
-- Struktura tabulky `oc_voucher_history`
--
...
--
-- Struktura tabulky `oc_voucher_theme`
--
...
--
-- Vypisuji data pro tabulku `oc_voucher_theme`
--
...
--
-- Struktura tabulky `oc_voucher_theme_description`
--
...
--
-- Vypisuji data pro tabulku `oc_voucher_theme_description`
--
...
--
-- Struktura tabulky `oc_weight_class`
--
...
--
-- Vypisuji data pro tabulku `oc_weight_class`
--
...
--
-- Struktura tabulky `oc_weight_class_description`
--
...
--
-- Vypisuji data pro tabulku `oc_weight_class_description`
--
...
--
-- Vypisuji data pro tabulku `oc_zone`
--
...
--
-- Struktura tabulky `oc_zone_to_geo_zone`
--
...
--
-- Vypisuji data pro tabulku `oc_zone_to_geo_zone`
--
...
--
-- Klíče pro tabulku `oc_address`
--
ALTER TABLE `oc_address`
  ADD PRIMARY KEY (`address_id`), ADD KEY `customer_id` (`customer_id`);

--
-- Klíče pro tabulku `oc_affiliate`
--
ALTER TABLE `oc_affiliate`
  ADD PRIMARY KEY (`affiliate_id`);

--
-- Klíče pro tabulku `oc_affiliate_activity`
--
ALTER TABLE `oc_affiliate_activity`
  ADD PRIMARY KEY (`affiliate_activity_id`);

--
-- Klíče pro tabulku `oc_affiliate_login`
--
ALTER TABLE `oc_affiliate_login`
  ADD PRIMARY KEY (`affiliate_login_id`), ADD KEY `email` (`email`), ADD KEY `ip` (`ip`);

--
-- Klíče pro tabulku `oc_affiliate_transaction`
--
ALTER TABLE `oc_affiliate_transaction`
  ADD PRIMARY KEY (`affiliate_transaction_id`);

--
-- Klíče pro tabulku `oc_api`
--
ALTER TABLE `oc_api`
  ADD PRIMARY KEY (`api_id`);

--
-- Klíče pro tabulku `oc_api_ip`
--
ALTER TABLE `oc_api_ip`
  ADD PRIMARY KEY (`api_ip_id`);

--
-- Klíče pro tabulku `oc_api_session`
--
ALTER TABLE `oc_api_session`
  ADD PRIMARY KEY (`api_session_id`);

--
-- Klíče pro tabulku `oc_attribute`
--
ALTER TABLE `oc_attribute`
  ADD PRIMARY KEY (`attribute_id`);

--
-- Klíče pro tabulku `oc_attribute_description`
--
ALTER TABLE `oc_attribute_description`
  ADD PRIMARY KEY (`attribute_id`,`language_id`);

--
-- Klíče pro tabulku `oc_attribute_group`
--
ALTER TABLE `oc_attribute_group`
  ADD PRIMARY KEY (`attribute_group_id`);

--
-- Klíče pro tabulku `oc_attribute_group_description`
--
ALTER TABLE `oc_attribute_group_description`
  ADD PRIMARY KEY (`attribute_group_id`,`language_id`);

--
-- Klíče pro tabulku `oc_banner`
--
ALTER TABLE `oc_banner`
  ADD PRIMARY KEY (`banner_id`);

--
-- Klíče pro tabulku `oc_banner_image`
--
ALTER TABLE `oc_banner_image`
  ADD PRIMARY KEY (`banner_image_id`);

--
-- Klíče pro tabulku `oc_cart`
--
ALTER TABLE `oc_cart`
  ADD PRIMARY KEY (`cart_id`), ADD KEY `cart_id` (`api_id`,`customer_id`,`session_id`,`product_id`,`recurring_id`);

--
-- Klíče pro tabulku `oc_category`
--
ALTER TABLE `oc_category`
  ADD PRIMARY KEY (`category_id`), ADD KEY `parent_id` (`parent_id`);

--
-- Klíče pro tabulku `oc_category_description`
--
ALTER TABLE `oc_category_description`
  ADD PRIMARY KEY (`category_id`,`language_id`), ADD KEY `name` (`name`);

--
-- Klíče pro tabulku `oc_category_filter`
--
ALTER TABLE `oc_category_filter`
  ADD PRIMARY KEY (`category_id`,`filter_id`);

--
-- Klíče pro tabulku `oc_category_path`
--
ALTER TABLE `oc_category_path`
  ADD PRIMARY KEY (`category_id`,`path_id`);

--
-- Klíče pro tabulku `oc_category_to_layout`
--
ALTER TABLE `oc_category_to_layout`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Klíče pro tabulku `oc_category_to_store`
--
ALTER TABLE `oc_category_to_store`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Klíče pro tabulku `oc_country`
--
ALTER TABLE `oc_country`
  ADD PRIMARY KEY (`country_id`);

--
-- Klíče pro tabulku `oc_coupon`
--
ALTER TABLE `oc_coupon`
  ADD PRIMARY KEY (`coupon_id`);

--
-- Klíče pro tabulku `oc_coupon_category`
--
ALTER TABLE `oc_coupon_category`
  ADD PRIMARY KEY (`coupon_id`,`category_id`);

--
-- Klíče pro tabulku `oc_coupon_history`
--
ALTER TABLE `oc_coupon_history`
  ADD PRIMARY KEY (`coupon_history_id`);

--
-- Klíče pro tabulku `oc_coupon_product`
--
ALTER TABLE `oc_coupon_product`
  ADD PRIMARY KEY (`coupon_product_id`);

--
-- Klíče pro tabulku `oc_currency`
--
ALTER TABLE `oc_currency`
  ADD PRIMARY KEY (`currency_id`);

--
-- Klíče pro tabulku `oc_customer`
--
ALTER TABLE `oc_customer`
  ADD PRIMARY KEY (`customer_id`);

--
-- Klíče pro tabulku `oc_customer_activity`
--
ALTER TABLE `oc_customer_activity`
  ADD PRIMARY KEY (`customer_activity_id`);

--
-- Klíče pro tabulku `oc_customer_group`
--
ALTER TABLE `oc_customer_group`
  ADD PRIMARY KEY (`customer_group_id`);

--
-- Klíče pro tabulku `oc_customer_group_description`
--
ALTER TABLE `oc_customer_group_description`
  ADD PRIMARY KEY (`customer_group_id`,`language_id`);

--
-- Klíče pro tabulku `oc_customer_history`
--
ALTER TABLE `oc_customer_history`
  ADD PRIMARY KEY (`customer_history_id`);

--
-- Klíče pro tabulku `oc_customer_ip`
--
ALTER TABLE `oc_customer_ip`
  ADD PRIMARY KEY (`customer_ip_id`), ADD KEY `ip` (`ip`);

--
-- Klíče pro tabulku `oc_customer_login`
--
ALTER TABLE `oc_customer_login`
  ADD PRIMARY KEY (`customer_login_id`), ADD KEY `email` (`email`), ADD KEY `ip` (`ip`);

--
-- Klíče pro tabulku `oc_customer_online`
--
ALTER TABLE `oc_customer_online`
  ADD PRIMARY KEY (`ip`);

--
-- Klíče pro tabulku `oc_customer_reward`
--
ALTER TABLE `oc_customer_reward`
  ADD PRIMARY KEY (`customer_reward_id`);

--
-- Klíče pro tabulku `oc_customer_search`
--
ALTER TABLE `oc_customer_search`
  ADD PRIMARY KEY (`customer_search_id`);

--
-- Klíče pro tabulku `oc_customer_transaction`
--
ALTER TABLE `oc_customer_transaction`
  ADD PRIMARY KEY (`customer_transaction_id`);

--
-- Klíče pro tabulku `oc_customer_wishlist`
--
ALTER TABLE `oc_customer_wishlist`
  ADD PRIMARY KEY (`customer_id`,`product_id`);

--
-- Klíče pro tabulku `oc_custom_field`
--
ALTER TABLE `oc_custom_field`
  ADD PRIMARY KEY (`custom_field_id`);

--
-- Klíče pro tabulku `oc_custom_field_customer_group`
--
ALTER TABLE `oc_custom_field_customer_group`
  ADD PRIMARY KEY (`custom_field_id`,`customer_group_id`);

--
-- Klíče pro tabulku `oc_custom_field_description`
--
ALTER TABLE `oc_custom_field_description`
  ADD PRIMARY KEY (`custom_field_id`,`language_id`);

--
-- Klíče pro tabulku `oc_custom_field_value`
--
ALTER TABLE `oc_custom_field_value`
  ADD PRIMARY KEY (`custom_field_value_id`);

--
-- Klíče pro tabulku `oc_custom_field_value_description`
--
ALTER TABLE `oc_custom_field_value_description`
  ADD PRIMARY KEY (`custom_field_value_id`,`language_id`);

--
-- Klíče pro tabulku `oc_download`
--
ALTER TABLE `oc_download`
  ADD PRIMARY KEY (`download_id`);

--
-- Klíče pro tabulku `oc_download_description`
--
ALTER TABLE `oc_download_description`
  ADD PRIMARY KEY (`download_id`,`language_id`);

--
-- Klíče pro tabulku `oc_event`
--
ALTER TABLE `oc_event`
  ADD PRIMARY KEY (`event_id`);

--
-- Klíče pro tabulku `oc_extension`
--
ALTER TABLE `oc_extension`
  ADD PRIMARY KEY (`extension_id`);

--
-- Klíče pro tabulku `oc_filter`
--
ALTER TABLE `oc_filter`
  ADD PRIMARY KEY (`filter_id`);

--
-- Klíče pro tabulku `oc_filter_description`
--
ALTER TABLE `oc_filter_description`
  ADD PRIMARY KEY (`filter_id`,`language_id`);

--
-- Klíče pro tabulku `oc_filter_group`
--
ALTER TABLE `oc_filter_group`
  ADD PRIMARY KEY (`filter_group_id`);

--
-- Klíče pro tabulku `oc_filter_group_description`
--
ALTER TABLE `oc_filter_group_description`
  ADD PRIMARY KEY (`filter_group_id`,`language_id`);

--
-- Klíče pro tabulku `oc_geo_zone`
--
ALTER TABLE `oc_geo_zone`
  ADD PRIMARY KEY (`geo_zone_id`);

--
-- Klíče pro tabulku `oc_information`
--
ALTER TABLE `oc_information`
  ADD PRIMARY KEY (`information_id`);

--
-- Klíče pro tabulku `oc_information_description`
--
ALTER TABLE `oc_information_description`
  ADD PRIMARY KEY (`information_id`,`language_id`);

--
-- Klíče pro tabulku `oc_information_to_layout`
--
ALTER TABLE `oc_information_to_layout`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Klíče pro tabulku `oc_information_to_store`
--
ALTER TABLE `oc_information_to_store`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Klíče pro tabulku `oc_language`
--
ALTER TABLE `oc_language`
  ADD PRIMARY KEY (`language_id`), ADD KEY `name` (`name`);

--
-- Klíče pro tabulku `oc_layout`
--
ALTER TABLE `oc_layout`
  ADD PRIMARY KEY (`layout_id`);

--
-- Klíče pro tabulku `oc_layout_module`
--
ALTER TABLE `oc_layout_module`
  ADD PRIMARY KEY (`layout_module_id`);

--
-- Klíče pro tabulku `oc_layout_route`
--
ALTER TABLE `oc_layout_route`
  ADD PRIMARY KEY (`layout_route_id`);

--
-- Klíče pro tabulku `oc_length_class`
--
ALTER TABLE `oc_length_class`
  ADD PRIMARY KEY (`length_class_id`);

--
-- Klíče pro tabulku `oc_length_class_description`
--
ALTER TABLE `oc_length_class_description`
  ADD PRIMARY KEY (`length_class_id`,`language_id`);

--
-- Klíče pro tabulku `oc_location`
--
ALTER TABLE `oc_location`
  ADD PRIMARY KEY (`location_id`), ADD KEY `name` (`name`);

--
-- Klíče pro tabulku `oc_manufacturer`
--
ALTER TABLE `oc_manufacturer`
  ADD PRIMARY KEY (`manufacturer_id`);

--
-- Klíče pro tabulku `oc_manufacturer_to_store`
--
ALTER TABLE `oc_manufacturer_to_store`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Klíče pro tabulku `oc_marketing`
--
ALTER TABLE `oc_marketing`
  ADD PRIMARY KEY (`marketing_id`);

--
-- Klíče pro tabulku `oc_menu`
--
ALTER TABLE `oc_menu`
  ADD PRIMARY KEY (`menu_id`);

--
-- Klíče pro tabulku `oc_menu_description`
--
ALTER TABLE `oc_menu_description`
  ADD PRIMARY KEY (`menu_id`,`language_id`);

--
-- Klíče pro tabulku `oc_menu_module`
--
ALTER TABLE `oc_menu_module`
  ADD PRIMARY KEY (`menu_module_id`), ADD KEY `menu_id` (`menu_id`);

--
-- Klíče pro tabulku `oc_modification`
--
ALTER TABLE `oc_modification`
  ADD PRIMARY KEY (`modification_id`);

--
-- Klíče pro tabulku `oc_module`
--
ALTER TABLE `oc_module`
  ADD PRIMARY KEY (`module_id`);

--
-- Klíče pro tabulku `oc_option`
--
ALTER TABLE `oc_option`
  ADD PRIMARY KEY (`option_id`);

--
-- Klíče pro tabulku `oc_option_description`
--
ALTER TABLE `oc_option_description`
  ADD PRIMARY KEY (`option_id`,`language_id`);

--
-- Klíče pro tabulku `oc_option_value`
--
ALTER TABLE `oc_option_value`
  ADD PRIMARY KEY (`option_value_id`);

--
-- Klíče pro tabulku `oc_option_value_description`
--
ALTER TABLE `oc_option_value_description`
  ADD PRIMARY KEY (`option_value_id`,`language_id`);

--
-- Klíče pro tabulku `oc_order`
--
ALTER TABLE `oc_order`
  ADD PRIMARY KEY (`order_id`);

--
-- Klíče pro tabulku `oc_order_custom_field`
--
ALTER TABLE `oc_order_custom_field`
  ADD PRIMARY KEY (`order_custom_field_id`);

--
-- Klíče pro tabulku `oc_order_history`
--
ALTER TABLE `oc_order_history`
  ADD PRIMARY KEY (`order_history_id`);

--
-- Klíče pro tabulku `oc_order_option`
--
ALTER TABLE `oc_order_option`
  ADD PRIMARY KEY (`order_option_id`);

--
-- Klíče pro tabulku `oc_order_product`
--
ALTER TABLE `oc_order_product`
  ADD PRIMARY KEY (`order_product_id`);

--
-- Klíče pro tabulku `oc_order_recurring`
--
ALTER TABLE `oc_order_recurring`
  ADD PRIMARY KEY (`order_recurring_id`);

--
-- Klíče pro tabulku `oc_order_recurring_transaction`
--
ALTER TABLE `oc_order_recurring_transaction`
  ADD PRIMARY KEY (`order_recurring_transaction_id`);

--
-- Klíče pro tabulku `oc_order_status`
--
ALTER TABLE `oc_order_status`
  ADD PRIMARY KEY (`order_status_id`,`language_id`);

--
-- Klíče pro tabulku `oc_order_total`
--
ALTER TABLE `oc_order_total`
  ADD PRIMARY KEY (`order_total_id`), ADD KEY `order_id` (`order_id`);

--
-- Klíče pro tabulku `oc_order_voucher`
--
ALTER TABLE `oc_order_voucher`
  ADD PRIMARY KEY (`order_voucher_id`);

--
-- Klíče pro tabulku `oc_product`
--
ALTER TABLE `oc_product`
  ADD PRIMARY KEY (`product_id`);

--
-- Klíče pro tabulku `oc_product_attribute`
--
ALTER TABLE `oc_product_attribute`
  ADD PRIMARY KEY (`product_id`,`attribute_id`,`language_id`);

--
-- Klíče pro tabulku `oc_product_description`
--
ALTER TABLE `oc_product_description`
  ADD PRIMARY KEY (`product_id`,`language_id`), ADD KEY `name` (`name`);

--
-- Klíče pro tabulku `oc_product_discount`
--
ALTER TABLE `oc_product_discount`
  ADD PRIMARY KEY (`product_discount_id`), ADD KEY `product_id` (`product_id`);

--
-- Klíče pro tabulku `oc_product_filter`
--
ALTER TABLE `oc_product_filter`
  ADD PRIMARY KEY (`product_id`,`filter_id`);

--
-- Klíče pro tabulku `oc_product_image`
--
ALTER TABLE `oc_product_image`
  ADD PRIMARY KEY (`product_image_id`), ADD KEY `product_id` (`product_id`);

--
-- Klíče pro tabulku `oc_product_option`
--
ALTER TABLE `oc_product_option`
  ADD PRIMARY KEY (`product_option_id`);

--
-- Klíče pro tabulku `oc_product_option_value`
--
ALTER TABLE `oc_product_option_value`
  ADD PRIMARY KEY (`product_option_value_id`);

--
-- Klíče pro tabulku `oc_product_recurring`
--
ALTER TABLE `oc_product_recurring`
  ADD PRIMARY KEY (`product_id`,`recurring_id`,`customer_group_id`);

--
-- Klíče pro tabulku `oc_product_related`
--
ALTER TABLE `oc_product_related`
  ADD PRIMARY KEY (`product_id`,`related_id`);

--
-- Klíče pro tabulku `oc_product_reward`
--
ALTER TABLE `oc_product_reward`
  ADD PRIMARY KEY (`product_reward_id`);

--
-- Klíče pro tabulku `oc_product_special`
--
ALTER TABLE `oc_product_special`
  ADD PRIMARY KEY (`product_special_id`), ADD KEY `product_id` (`product_id`);

--
-- Klíče pro tabulku `oc_product_to_category`
--
ALTER TABLE `oc_product_to_category`
  ADD PRIMARY KEY (`product_id`,`category_id`), ADD KEY `category_id` (`category_id`);

--
-- Klíče pro tabulku `oc_product_to_download`
--
ALTER TABLE `oc_product_to_download`
  ADD PRIMARY KEY (`product_id`,`download_id`);

--
-- Klíče pro tabulku `oc_product_to_layout`
--
ALTER TABLE `oc_product_to_layout`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Klíče pro tabulku `oc_product_to_store`
--
ALTER TABLE `oc_product_to_store`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Klíče pro tabulku `oc_recurring`
--
ALTER TABLE `oc_recurring`
  ADD PRIMARY KEY (`recurring_id`);

--
-- Klíče pro tabulku `oc_recurring_description`
--
ALTER TABLE `oc_recurring_description`
  ADD PRIMARY KEY (`recurring_id`,`language_id`);

--
-- Klíče pro tabulku `oc_return`
--
ALTER TABLE `oc_return`
  ADD PRIMARY KEY (`return_id`);

--
-- Klíče pro tabulku `oc_return_action`
--
ALTER TABLE `oc_return_action`
  ADD PRIMARY KEY (`return_action_id`,`language_id`);

--
-- Klíče pro tabulku `oc_return_history`
--
ALTER TABLE `oc_return_history`
  ADD PRIMARY KEY (`return_history_id`);

--
-- Klíče pro tabulku `oc_return_reason`
--
ALTER TABLE `oc_return_reason`
  ADD PRIMARY KEY (`return_reason_id`,`language_id`);

--
-- Klíče pro tabulku `oc_return_status`
--
ALTER TABLE `oc_return_status`
  ADD PRIMARY KEY (`return_status_id`,`language_id`);

--
-- Klíče pro tabulku `oc_review`
--
ALTER TABLE `oc_review`
  ADD PRIMARY KEY (`review_id`), ADD KEY `product_id` (`product_id`);

--
-- Klíče pro tabulku `oc_setting`
--
ALTER TABLE `oc_setting`
  ADD PRIMARY KEY (`setting_id`);

--
-- Klíče pro tabulku `oc_stock_status`
--
ALTER TABLE `oc_stock_status`
  ADD PRIMARY KEY (`stock_status_id`,`language_id`);

--
-- Klíče pro tabulku `oc_store`
--
ALTER TABLE `oc_store`
  ADD PRIMARY KEY (`store_id`);

--
-- Klíče pro tabulku `oc_tax_class`
--
ALTER TABLE `oc_tax_class`
  ADD PRIMARY KEY (`tax_class_id`);

--
-- Klíče pro tabulku `oc_tax_rate`
--
ALTER TABLE `oc_tax_rate`
  ADD PRIMARY KEY (`tax_rate_id`);

--
-- Klíče pro tabulku `oc_tax_rate_to_customer_group`
--
ALTER TABLE `oc_tax_rate_to_customer_group`
  ADD PRIMARY KEY (`tax_rate_id`,`customer_group_id`);

--
-- Klíče pro tabulku `oc_tax_rule`
--
ALTER TABLE `oc_tax_rule`
  ADD PRIMARY KEY (`tax_rule_id`);

--
-- Klíče pro tabulku `oc_theme`
--
ALTER TABLE `oc_theme`
  ADD PRIMARY KEY (`theme_id`);

--
-- Klíče pro tabulku `oc_translation`
--
ALTER TABLE `oc_translation`
  ADD PRIMARY KEY (`translation_id`);

--
-- Klíče pro tabulku `oc_upload`
--
ALTER TABLE `oc_upload`
  ADD PRIMARY KEY (`upload_id`);

--
-- Klíče pro tabulku `oc_url_alias`
--
ALTER TABLE `oc_url_alias`
  ADD PRIMARY KEY (`url_alias_id`), ADD KEY `query` (`query`), ADD KEY `keyword` (`keyword`);

--
-- Klíče pro tabulku `oc_user`
--
ALTER TABLE `oc_user`
  ADD PRIMARY KEY (`user_id`);

--
-- Klíče pro tabulku `oc_user_group`
--
ALTER TABLE `oc_user_group`
  ADD PRIMARY KEY (`user_group_id`);

--
-- Klíče pro tabulku `oc_voucher`
--
ALTER TABLE `oc_voucher`
  ADD PRIMARY KEY (`voucher_id`);

--
-- Klíče pro tabulku `oc_voucher_history`
--
ALTER TABLE `oc_voucher_history`
  ADD PRIMARY KEY (`voucher_history_id`);

--
-- Klíče pro tabulku `oc_voucher_theme`
--
ALTER TABLE `oc_voucher_theme`
  ADD PRIMARY KEY (`voucher_theme_id`);

--
-- Klíče pro tabulku `oc_voucher_theme_description`
--
ALTER TABLE `oc_voucher_theme_description`
  ADD PRIMARY KEY (`voucher_theme_id`,`language_id`);

--
-- Klíče pro tabulku `oc_weight_class`
--
ALTER TABLE `oc_weight_class`
  ADD PRIMARY KEY (`weight_class_id`);

--
-- Klíče pro tabulku `oc_weight_class_description`
--
ALTER TABLE `oc_weight_class_description`
  ADD PRIMARY KEY (`weight_class_id`,`language_id`);

--
-- Klíče pro tabulku `oc_zone`
--
ALTER TABLE `oc_zone`
  ADD PRIMARY KEY (`zone_id`);

--
-- Klíče pro tabulku `oc_zone_to_geo_zone`
--
...
--
-- AUTO_INCREMENT pro tabulku `oc_address`
--
ALTER TABLE `oc_address`
  MODIFY `address_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_affiliate`
--
ALTER TABLE `oc_affiliate`
  MODIFY `affiliate_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_affiliate_activity`
--
ALTER TABLE `oc_affiliate_activity`
  MODIFY `affiliate_activity_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_affiliate_login`
--
ALTER TABLE `oc_affiliate_login`
  MODIFY `affiliate_login_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_affiliate_transaction`
--
ALTER TABLE `oc_affiliate_transaction`
  MODIFY `affiliate_transaction_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_api`
--
ALTER TABLE `oc_api`
  MODIFY `api_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pro tabulku `oc_api_ip`
--
ALTER TABLE `oc_api_ip`
  MODIFY `api_ip_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_api_session`
--
ALTER TABLE `oc_api_session`
  MODIFY `api_session_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_attribute`
--
ALTER TABLE `oc_attribute`
  MODIFY `attribute_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT pro tabulku `oc_attribute_group`
--
ALTER TABLE `oc_attribute_group`
  MODIFY `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT pro tabulku `oc_banner`
--
ALTER TABLE `oc_banner`
  MODIFY `banner_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT pro tabulku `oc_banner_image`
--
ALTER TABLE `oc_banner_image`
  MODIFY `banner_image_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=113;
--
-- AUTO_INCREMENT pro tabulku `oc_cart`
--
ALTER TABLE `oc_cart`
  MODIFY `cart_id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_category`
--
ALTER TABLE `oc_category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=59;
--
-- AUTO_INCREMENT pro tabulku `oc_country`
--
ALTER TABLE `oc_country`
  MODIFY `country_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=258;
--
-- AUTO_INCREMENT pro tabulku `oc_coupon`
--
ALTER TABLE `oc_coupon`
  MODIFY `coupon_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT pro tabulku `oc_coupon_history`
--
ALTER TABLE `oc_coupon_history`
  MODIFY `coupon_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_coupon_product`
--
ALTER TABLE `oc_coupon_product`
  MODIFY `coupon_product_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_currency`
--
ALTER TABLE `oc_currency`
  MODIFY `currency_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pro tabulku `oc_customer`
--
ALTER TABLE `oc_customer`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_customer_activity`
--
ALTER TABLE `oc_customer_activity`
  MODIFY `customer_activity_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_customer_group`
--
ALTER TABLE `oc_customer_group`
  MODIFY `customer_group_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pro tabulku `oc_customer_history`
--
ALTER TABLE `oc_customer_history`
  MODIFY `customer_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_customer_ip`
--
ALTER TABLE `oc_customer_ip`
  MODIFY `customer_ip_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_customer_login`
--
ALTER TABLE `oc_customer_login`
  MODIFY `customer_login_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_customer_reward`
--
ALTER TABLE `oc_customer_reward`
  MODIFY `customer_reward_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_customer_search`
--
ALTER TABLE `oc_customer_search`
  MODIFY `customer_search_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_customer_transaction`
--
ALTER TABLE `oc_customer_transaction`
  MODIFY `customer_transaction_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_custom_field`
--
ALTER TABLE `oc_custom_field`
  MODIFY `custom_field_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_custom_field_value`
--
ALTER TABLE `oc_custom_field_value`
  MODIFY `custom_field_value_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_download`
--
ALTER TABLE `oc_download`
  MODIFY `download_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_event`
--
ALTER TABLE `oc_event`
  MODIFY `event_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pro tabulku `oc_extension`
--
ALTER TABLE `oc_extension`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=29;
--
-- AUTO_INCREMENT pro tabulku `oc_filter`
--
ALTER TABLE `oc_filter`
  MODIFY `filter_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_filter_group`
--
ALTER TABLE `oc_filter_group`
  MODIFY `filter_group_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_geo_zone`
--
ALTER TABLE `oc_geo_zone`
  MODIFY `geo_zone_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT pro tabulku `oc_information`
--
ALTER TABLE `oc_information`
  MODIFY `information_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT pro tabulku `oc_language`
--
ALTER TABLE `oc_language`
  MODIFY `language_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pro tabulku `oc_layout`
--
ALTER TABLE `oc_layout`
  MODIFY `layout_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT pro tabulku `oc_layout_module`
--
ALTER TABLE `oc_layout_module`
  MODIFY `layout_module_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=74;
--
-- AUTO_INCREMENT pro tabulku `oc_layout_route`
--
ALTER TABLE `oc_layout_route`
  MODIFY `layout_route_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=67;
--
-- AUTO_INCREMENT pro tabulku `oc_length_class`
--
ALTER TABLE `oc_length_class`
  MODIFY `length_class_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pro tabulku `oc_location`
--
ALTER TABLE `oc_location`
  MODIFY `location_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_manufacturer`
--
ALTER TABLE `oc_manufacturer`
  MODIFY `manufacturer_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT pro tabulku `oc_marketing`
--
ALTER TABLE `oc_marketing`
  MODIFY `marketing_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_menu`
--
ALTER TABLE `oc_menu`
  MODIFY `menu_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_modification`
--
ALTER TABLE `oc_modification`
  MODIFY `modification_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_module`
--
ALTER TABLE `oc_module`
  MODIFY `module_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=32;
--
-- AUTO_INCREMENT pro tabulku `oc_option`
--
ALTER TABLE `oc_option`
  MODIFY `option_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT pro tabulku `oc_option_value`
--
ALTER TABLE `oc_option_value`
  MODIFY `option_value_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT pro tabulku `oc_order`
--
ALTER TABLE `oc_order`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_order_custom_field`
--
ALTER TABLE `oc_order_custom_field`
  MODIFY `order_custom_field_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_order_history`
--
ALTER TABLE `oc_order_history`
  MODIFY `order_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_order_option`
--
ALTER TABLE `oc_order_option`
  MODIFY `order_option_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_order_product`
--
ALTER TABLE `oc_order_product`
  MODIFY `order_product_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_order_recurring`
--
ALTER TABLE `oc_order_recurring`
  MODIFY `order_recurring_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_order_recurring_transaction`
--
ALTER TABLE `oc_order_recurring_transaction`
  MODIFY `order_recurring_transaction_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_order_status`
--
ALTER TABLE `oc_order_status`
  MODIFY `order_status_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT pro tabulku `oc_order_total`
--
ALTER TABLE `oc_order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_order_voucher`
--
ALTER TABLE `oc_order_voucher`
  MODIFY `order_voucher_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_product`
--
ALTER TABLE `oc_product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
-- AUTO_INCREMENT pro tabulku `oc_product_discount`
--
ALTER TABLE `oc_product_discount`
  MODIFY `product_discount_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=441;
--
-- AUTO_INCREMENT pro tabulku `oc_product_image`
--
ALTER TABLE `oc_product_image`
  MODIFY `product_image_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2352;
--
-- AUTO_INCREMENT pro tabulku `oc_product_option`
--
ALTER TABLE `oc_product_option`
  MODIFY `product_option_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=227;
--
-- AUTO_INCREMENT pro tabulku `oc_product_option_value`
--
ALTER TABLE `oc_product_option_value`
  MODIFY `product_option_value_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT pro tabulku `oc_product_reward`
--
ALTER TABLE `oc_product_reward`
  MODIFY `product_reward_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=546;
--
-- AUTO_INCREMENT pro tabulku `oc_product_special`
--
ALTER TABLE `oc_product_special`
  MODIFY `product_special_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=440;
--
-- AUTO_INCREMENT pro tabulku `oc_recurring`
--
ALTER TABLE `oc_recurring`
  MODIFY `recurring_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_return`
--
ALTER TABLE `oc_return`
  MODIFY `return_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_return_action`
--
ALTER TABLE `oc_return_action`
  MODIFY `return_action_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pro tabulku `oc_return_history`
--
ALTER TABLE `oc_return_history`
  MODIFY `return_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_return_reason`
--
ALTER TABLE `oc_return_reason`
  MODIFY `return_reason_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pro tabulku `oc_return_status`
--
ALTER TABLE `oc_return_status`
  MODIFY `return_status_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pro tabulku `oc_review`
--
ALTER TABLE `oc_review`
  MODIFY `review_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_setting`
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=395;
--
-- AUTO_INCREMENT pro tabulku `oc_stock_status`
--
ALTER TABLE `oc_stock_status`
  MODIFY `stock_status_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT pro tabulku `oc_store`
--
ALTER TABLE `oc_store`
  MODIFY `store_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pro tabulku `oc_tax_class`
--
ALTER TABLE `oc_tax_class`
  MODIFY `tax_class_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT pro tabulku `oc_tax_rate`
--
ALTER TABLE `oc_tax_rate`
  MODIFY `tax_rate_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=88;
--
-- AUTO_INCREMENT pro tabulku `oc_tax_rule`
--
ALTER TABLE `oc_tax_rule`
  MODIFY `tax_rule_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=129;
--
-- AUTO_INCREMENT pro tabulku `oc_theme`
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_translation`
--
ALTER TABLE `oc_translation`
  MODIFY `translation_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_upload`
--
ALTER TABLE `oc_upload`
  MODIFY `upload_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_url_alias`
--
ALTER TABLE `oc_url_alias`
  MODIFY `url_alias_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=844;
--
-- AUTO_INCREMENT pro tabulku `oc_user`
--
ALTER TABLE `oc_user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pro tabulku `oc_user_group`
--
ALTER TABLE `oc_user_group`
  MODIFY `user_group_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT pro tabulku `oc_voucher`
--
ALTER TABLE `oc_voucher`
  MODIFY `voucher_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_voucher_history`
--
ALTER TABLE `oc_voucher_history`
  MODIFY `voucher_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pro tabulku `oc_voucher_theme`
--
ALTER TABLE `oc_voucher_theme`
  MODIFY `voucher_theme_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT pro tabulku `oc_weight_class`
--
ALTER TABLE `oc_weight_class`
  MODIFY `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT pro tabulku `oc_zone`
--
ALTER TABLE `oc_zone`
  MODIFY `zone_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4236;
--
-- AUTO_INCREMENT pro tabulku `oc_zone_to_geo_zone`
--
ALTER TABLE `oc_zone_to_geo_zone`
